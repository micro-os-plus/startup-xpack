...
- name the post like: **µOS++ startup v1.0.8 released**
...
- commit all changes
- update `CHANGELOG.md`; commit with a message like _CHANGELOG: prepare v1.0.8_
...
- `npm dist-tag add @micro-os-plus/micro-test-plus@1.0.8 latest`
- `npm dist-tag ls @@micro-os-plus/micro-test-plus`
...
- paste the release name like **µOS++ startup v1.0.8 released**
