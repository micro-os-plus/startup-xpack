...
- name the post like: **µOS++ startup v4.0.0 released**
...
- `npm dist-tag add @micro-os-plus/startup@4.0.0 latest`
- `npm dist-tag ls @micro-os-plus/startup`
...
- paste the release name like **µOS++ startup v4.0.0 released**
